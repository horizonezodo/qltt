    ...
    <div class="page-content-wrap" style="height: 738px;">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <form class="form-horizontal" action="/admin/editCate/${cate.cateId}" method="post">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title">Update Category</h3>
                            <ul class="panel-controls">
                                <li><a href="/cate-list" class="panel-remove"><span class="fa fa-times"></span></a></li>
                            </ul>
                        </div>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-xs-12">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="cateName" value="${cate.cateName}" class="form-control"/>
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-xs-12">
                                    <label class="check"><input type="checkbox" class="icheckbox" name="isActivate" value="true" ${cate.cateActivate?then('checked', '')}/> Is Activate</label>
