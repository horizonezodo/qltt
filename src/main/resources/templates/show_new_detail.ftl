...
<div class="page-container">
    ...
    <div class="page-content">
        <#if newDetail??>
            <div>
                <button class="btn btn-default btn-rounded btn-sm"><a href="/admin/show-edit-new-detail/${newDetail.newDetailId}">Update news detail</a></button>
                <button class="btn btn-danger btn-rounded btn-sm"><a href="/admin/delete-new-detail/${newDetail.newDetailId}">Delete news</a></button>
                <button class="btn btn-default btn-rounded btn-sm"><a href="/cate-list">Back</a></button>
            </div>
        ...
        <#else>
            <tr>
                <button class="btn btn-default btn-rounded btn-sm"><a href="/admin/addNewDetail/${cateId}">Create news Detail</a></button>
